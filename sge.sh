...
SEEDS="58a458a7136da7e8cc55357999aa89f5fd262588@sge.peers.stavr.tech:1156"
PEERS=$(curl -sS https://sge.rpc.m.stavr.tech/net_info | jq -r '.result.peers[] | "\(.node_info.id)@\(.remote_ip):\(.node_info.listen_addr)"' | awk -F ':' '{print $1":"$(NF)}' | paste -sd, -)
MAX_NUM_INBOUND_PEERS=10
MAX_NUM_OUTBOUND_PEERS=40

SNAP_RPC="https://sge.rpc.m.stavr.tech:443"
SNAPSHOTS_DIR="https://server-1.stavr.tech/Mainnet/Sge/"
...
WASM_URL="https://sge.wasm.stavr.tech/wasm-sge.tar.lz4"
